...
function CloudflareCardIcon() {
  return (
    <div style={{ width: IC, height: IC, borderRadius: 3, overflow: 'hidden', flexShrink: 0, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: '#F6821F' }}>
      <svg width="15" height="12" viewBox="0 0 52 36" fill="none">
